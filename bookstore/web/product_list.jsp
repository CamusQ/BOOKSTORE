...
<%@ page import="com.gyf.bookstore.model.PageResult" %>
                    ...
                    <tr>
                        <td>
                                    ...
                                    <c:forEach items="${pageResult.list}" var="product">
                                        ...
                                        <td>
                                            ...
                                            <div class="divbookpic">
                                                <p>
                                                    <a href="${pageContext.request.contextPath}/productInfo?id=${product.id}"><img
                            ...
                            <div class="pagination">
                                <!-- 上也 -->
                                第${pageResult.currentPage}页/共${pageResult.totalPage}
                                <ul>
                                    ...
                                    <c:if test="${pageResult.currentPage != pageResult.totalPage}">
                                        <li>
                                            <a href="${pageContext.request.contextPath}/showProductByPage?category=${category}&page=${pageResult.currentPage + 1}">下一页
                                                &gt;&gt;</a></li>
